...
def load_model(best_model_path, modal_mode, reducer_path):
    print("Loading model...")
    ...
    reducer.load_state_dict(torch.load(reducer_path))
    classifier.load_state_dict(torch.load(best_model_path))
    classifier.eval() 

    print("Done")

    return resnet50, bert_model, bert_tokenizer, classifier, reducer
